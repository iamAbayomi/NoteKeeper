...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION = "com.appdot.io.notekeeper.NOTE_POSITION";
    ...
    private void readDisplayDataValues() {
    ...
    private void sendEmail() {
        ...
        String text = "Checkout what I learned in  the Pluralsight courses \"" +
